<template>
  <svg class="svg" id="svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    "></path>
      ...
      <line x1="400.63" y1="138.83" x2="400.63" y2="159.58" class="cloud-a" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></line>
      <line x1="400.63" y1="126.39" x2="400.63" y2="134.68" class="cloud-a" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></line>
      <line x1="400.63" y1="118.63" x2="400.63" y2="123.07" class="cloud-a" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></line>
      <polyline points="396.71 157.16 400.63 162.01 404.55 157.16" class="cloud-a" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></polyline>
      ...
      <line x1="171.24" y1="385.15" x2="171.24" y2="364.41" class="cloud-b" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></line>
      <line x1="171.24" y1="397.6" x2="171.24" y2="389.3" class="cloud-b" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></line>
      <line x1="171.24" y1="405.36" x2="171.24" y2="400.92" class="cloud-b" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    "></line>
      <polyline points="175.16 366.83 171.24 361.98 167.32 366.83" class="cloud-b" style="
      fill: none;
      stroke: #263238;
      stroke-linecap: round;
      stroke-linejoin: round;
    ...
    "></rect>
      ...
      stroke-linejoin: round;
    "></rect>
      <line x1="300.48" y1="175.7" x2="314.2" y2="175.7" class="cmd-a"></line>
      <line x1="307.34" y1="179.53" x2="331.08" y2="179.53" class="cmd-b"></line>
      <line x1="304.31" y1="183.1" x2="311.3" y2="183.1" class="cmd-c"></line>
      <line x1="307.34" y1="187.31" x2="323.33" y2="187.31" class="cmd-d"></line>
      <line x1="300.48" y1="191.13" x2="314.2" y2="191.13" class="cmd-e"></line>
    ...
    "></rect>
      ...
      stroke-linejoin: round;
    "></rect>
      <line x1="98.68" y1="311.02" x2="112.39" y2="311.02" class="cmd-a"></line>
      <line x1="105.53" y1="314.84" x2="129.27" y2="314.84" class="cmd-b"></line>
      <line x1="102.5" y1="318.41" x2="109.49" y2="318.41" class="cmd-c"></line>
      <line x1="105.53" y1="322.62" x2="121.52" y2="322.62" class="cmd-d"></line>
      <line x1="98.68" y1="326.45" x2="112.39" y2="326.45" class="cmd-e"></line>
    </g>
      ...
      <div id="items" class="items">
        ...
        <div class="item">
          <div class="content" @click="link('css')">
            ...
            <p class="details">层叠样式表是一种用来为结构化文档添加样式的计算机语言</p>
          </div>
        </div>
        <div class="item">
          <div class="content" @click="link('javascript')">
            ...
            <p class="details">JavaScript 是一种基于原型、多范式、单线程的动态语言</p>
          </div>
        </div>
        <div class="item">
        ...
        <div class="item">
          <div class="content" @click="link('webpack')">
            ...
            <p class="details">构建工具是一个把源代码生成可执行应用程序的过程自动化的程序</p>
          </div>
        </div>
        <div class="item">
          <div class="content" @click="link('chrome')">
            ...
            <p class="details">网页浏览器是一种用于检索并展示万维网信息资源的应用程序</p>
          </div>
        </div>
        <div class="item">
          <div class="content" @click="link('network')">
            ...
            <p class="details">TCP/IP 是指能够在多个不同网络间实现信息传输的协议簇。</p>
          </div>
        </div>
        <div class="item">
          <div class="content" @click="link('datastructure')">
            ...
            <p class="details">在计算机科学中，数据结构是计算机中存储、组织数据的方式</p>
          </div>
        </div>
      </div>
      <div class="swiper">
        <div class="swiper-horizontal">
          <n-carousel effect="fade" dot-type="line" :interval="3000" autoplay show-arrow>
            ...
            <div class="demo-item" style="color:#34a853">
              <h1 style="font-size:38px;font-weight:bold">项目二</h1>
            </div>
            <div class="demo-item" style="color:#fbbc05">
              <h1 style="font-size:38px;font-weight:bold">项目三</h1>
            </div>
  ...
  setup() {
    ...
    window.onresize = () => {
      ...
      if (window.screenWidths < 640) {
        ...
        container.style.height = items.offsetHeight + "px"; // 实时获取 items 的高度并赋值给 containser
      }
    }
    ...
    onMounted(() => {
      ...
      if (window.screen.width < 640) {
        ...
        container.style.height = items.offsetHeight + "px"; // 获取 items 的高度并赋值给 containser
      }
    })
...
.cmd-a {
  animation: cmd-a 10s infinite;
}

.cmd-b {
  animation: cmd-b 10s infinite;
}

.cmd-c {
  animation: cmd-c 10s infinite;
}

.cmd-d {
  animation: cmd-d 10s infinite;
}

.cmd-e {
  animation: cmd-e 10s infinite;
}
