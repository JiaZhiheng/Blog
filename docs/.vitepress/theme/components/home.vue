          ...
          <div class="swiper">
              <div class="swiper-horizontal">
                <div class="tdesign-demo-block--swiper">
                  <t-swiper animation="fade" :height="404">
                    <t-swiper-item>
                      <div class="demo-item" style="background-color:#4285f4"></div>
                    </t-swiper-item>
                    <t-swiper-item>
                      <div class="demo-item" style="background-color:#34a853"></div>
                    </t-swiper-item>
                    <t-swiper-item>
                      <div class="demo-item" style="background-color:#fbbc05"></div>
                    </t-swiper-item>
                    <t-swiper-item>
                      <div class="demo-item" style="background-color:#ea4335"></div>
                    </t-swiper-item>
                  </t-swiper>
                </div>
              </div>
...
@media screen and (min-width: 960px) {
    ...
    :deep(.t-swiper--inside .t-swiper__navigation) {
      bottom: 16px;
    }
}
</style>
